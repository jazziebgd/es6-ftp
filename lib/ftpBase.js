 ...
 * @property {Boolean}                      calculateStatistics     Flag to enable or disable calculating statistics on the fly
 * @property {Boolean}                      keepStatisticsHistory   Flag to enable or disable storing statistics (speed, avg speed etc.) history
...
class FtpBase extends EventEmitter {
    ...
    log() {
        ...
        this.emit('log', Array.prototype.slice.call(arguments), this);
