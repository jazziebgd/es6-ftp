...
class FtpClient extends FtpBase {
    ...
    async disconnect() {
        ...
        if (!disconnected) {
            ...
            let _disconnectSocket = async (resolveFirst, rejectFirst) => {
                if (this.socket && !this.socket.destroyed) {
                    ...
                    this.socket.once('close', _onSocketClose);
                    this.socket.destroy();
                } else {
            ...
            let _disconnectSecureSocket = async (resolveSecond, rejectSecond) => {
                if (this.secureSocket && !this.secureSocket.destroyed) {
                    ...
                    this.secureSocket.once('close', _onSecureSocketClose);
            ...
            if (passiveSocket) {
                ...
                if (storRequest && storRequest.responseCode && (storRequest.responseCode === 150 || storRequest.responseCode === 125)) {
                    let onend = async () => {
                        ...
                        this.removeObjListener(dest, 'finish', onfinish);
                    ...
                    this.addOnceObjListener(dest, 'finish', onfinish);
