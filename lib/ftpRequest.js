...
class FtpRequest extends EventEmitter {
    ...
    addStatisticEntry() {
        ...
        this.client.updateDataStats(entryData.transferred, entryData.chunkSize);
    ...
    onProgress (transferred, chunkSize, limiterObject, isFinal) {
        ...
        if (this.lastProgressTimestamp) {
            ...
            let lastEntry = _.last(this.progressHistory);
        ...
        this.lastProgressEntry = progressEntry;
        this.log('Progress - chunk size: ' + chunkSize + ', total transferred: ' + transferred + ', final: ' + isFinal);
    }
