...
class FtpLimiter extends Transform {
    ...
    /**
     * Sets callback timeout for this limiter
     *
     * @param {Number} callbackTimeout  Callback timeout in ms
     *
     * @return {undefined}
     */
    setCallbackTimeout(callbackTimeout = 0) {
        this.log('LIMITER setting callback timeout to ' + callbackTimeout);
